...
if(empty($_SESSION["user_id"]))
{
   ...
   foreach($_SESSION["cart_item"] as $item)
   {
      $item_total += ($item["price"]*$item["quantity"]);
                ...
                if(isset($_POST['mod'])){
                    $payment_mod = $_POST['mod'];
                    if ($payment_mod == "paypal") {
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html"> Vadodara FOS </a>
                                    ...
                                    <div class="cart-totals margin-b-20">
                                        ...
                                        <div class="cart-totals-fields">
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Cart Subtotal</td>
                                                        <td> <?php echo "Rs.".$item_total.".00"; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Shipping &amp; Handling</td>
                                                        <td>Free delivery in Vadodara</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-color"><strong>Total</strong></td>
                                                        <td class="text-color"><strong> <?php echo "Rs.".$item_total.".00"; ?></strong></td>
                                                    </tr>
                                                </tbody>
